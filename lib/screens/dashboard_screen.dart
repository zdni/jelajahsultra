    ...
    if (toursProvider.totalWisata > 0 && allTours == null) {
      if(mounted) {
        setState(() {
          ...
          toursByRating = toursProvider.allWisataByRating;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const SizedBox(width: 25.0),
                      Text(
                        'Daftar Tempat Wisata Terpopuler',
                        style: GoogleFonts.getFont(
                          'Quicksand',
                          color: const Color.fromRGBO(32, 32, 32, 1.0),
                          fontSize: 16.0,
                  ...
                  : Container(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: toursByRating.length,
                      itemBuilder: (context, index) {
                        return Stack(
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15.0),
                                image: DecorationImage(
                                  image: NetworkImage("$urlPathUpload${toursByRating[index].image}"),
                                  fit: BoxFit.cover
                                )
                              ),
                              width: 250,
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () => Navigator.pushNamed(
                                        context, 
                                        DetailScreen.routeName, 
                                        arguments: toursByRating[index].id
                                      ),
                                      child: const SizedBox(
                                        width: 30,
                                        height: 30,
                  ...
                  //     width: 200,
                  //     decoration: BoxDecoration(
                  //       border: Border.all(color: const Color.fromRGBO(3, 169, 251, 1.0)),
                  //       borderRadius: BorderRadius.circular(8.0),
                  //       // color: const Color.fromRGBO(3, 169, 251, 1.0)
                  //     ),
                  //     child: Row(
